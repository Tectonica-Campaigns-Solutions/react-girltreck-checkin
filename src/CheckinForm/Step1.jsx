        ...
        <div className="row">
          <div className="col-lg-7">
            <div className="step__hero">
              ...
              <h1 className="step__hero__headline">
                Calling all Leaders to
                <br />
                Check in!
              </h1>
            </div>
          ...
          <div className="col-lg-5 step__content">
            <div className="step__intro">
              ...
              <p>
                Check-in every time you lead your crew. Help us grow this
                movement and show that we are taking over 1000 Black
            ...
            <div className="step__inputs">
              <div className="input-wrapper">
                ...
                />
                {showSimilar && showSimilar.show && (
                  <div className="box-mails">
                    <p>
                      There are this similar emails already registered, choose
                      one to proceed:
                    </p>
                    <div onClick={() => handlerPopUpMail(formData.Email)}>
                      {formData.Email}
                    </div>
                    {showSimilar.items.map((item, index) => (
                      <div key={index} onClick={() => handlerPopUpMail(item)}>
                        {item}
                      </div>
                    ))}
                  </div>
              ...
              <div className="input-wrapper">
                <label htmlFor="How many women are in your crew?">
                  How many women are in you walking with?*
                </label>
                <input
                  onChange={(e) => checkFormState(e)}
                  type="number"
                  ...
                  placeholder=""
                  value={
                    formData["How many women are in your crew?"]
                      ? formData["How many women are in your crew?"]
                      : ""
                  }
                />
            ...
            <div>
              <div className="buble-link">
                <p className="link-open-bubble">
                  Are you a solo trekker or crew walk attendee?
                </p>
                <img
                  src={iconInfo}
                  alt=""
                  onClick={() => handlerBuble(true)}
                  className="icon-info"
                />
                {showBubble && (
                  <div className="buble-box">
                    If so, please checkin on instagram or facebook using
                    #girltrek every-time you walk. Represent yourself or your
                    crew and help us show the world this movement is taking over
                    the streets. Our goal is 1,000 tags each week.
                  </div>
                )}
              </div>
            </div>
